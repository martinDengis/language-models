...
def train_model(model, train_loader, test_loader, optimizer, loss_fn, num_epochs, device, model_name, vocab, tokenizer=None, generate_samples=False):
    ...
    Args:
        ...
        tokenizer (callable, optional): Function to tokenize input text. Required for sample text generation.
        generate_samples (bool): If True, generates sample text every few epochs.
