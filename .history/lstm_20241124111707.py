...
with open("preprocessing_params.json", "w", encoding='utf-8') as f:
    json.dump(preprocessing_params, f, ensure_ascii=False, indent=4)

# Sauvegarder les loaders dans des fichiers séparés
