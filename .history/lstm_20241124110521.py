...
with open(os.path.join(exp_dir, "preprocessing_params.pkl"), "wb") as f:
    pickle.dump(preprocessing_params, f)

with open(os.path.join(exp_dir, "train_loader.pkl"), "wb") as f:
    pickle.dump(train_loader, f)

with open(os.path.join(exp_dir, "test_loader.pkl"), "wb") as f:
    pickle.dump(test_loader, f)

print("Preprocessing parameters saved successfully")
