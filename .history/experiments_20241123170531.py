...
def experiment_1(train_loader, test_loader, vocab):
    ...
    # Train models
    print("Training LSTM...")
    lstm_results = train_model(lstm_model, train_loader, test_loader, lstm_optimizer, lstm_loss_fn, nepochs, device, "LSTM_Model", vocab, tokenizer, generate_samples=True)

    
    print("Training GRU...")
    gru_results = train_model(gru_model, train_loader, test_loader, gru_optimizer, gru_loss_fn, nepochs, device, "GRU_Model", vocab, tokenizer, generate_samples=True)
