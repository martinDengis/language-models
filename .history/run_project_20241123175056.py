...
from config import batch_size, hidden_size, num_layers
from models.lstm_model import initialize_lstm_model
from models.gru_model import initialize_gru_model
