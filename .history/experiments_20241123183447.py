...
def experiment_1(train_loader, test_loader, vocab, device):
    ...
    # Initialize models
    lstm_model = LSTMOneHot(len(vocab), hidden_size, num_layers, dropout=0.2).to(device)
    gru_model = GRUOneHot(len(vocab), hidden_size, num_layers, dropout=0.2).to(device)
