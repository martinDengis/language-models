...
from lstm import create_experiment_dir, calculate_perplexity, generate_text, save_training_plots
import re
import pickle
...
# Load the data and preprocessing parameters
preprocessing_params_path = os.path.join(lstm_results_dir, "preprocessing_params.pkl")
train_loader_path = os.path.join(lstm_results_dir, "train_loader.pkl")
test_loader_path = os.path.join(lstm_results_dir, "test_loader.pkl")
...
vocab = preprocessing_params["vocab"]
tokenizer = preprocessing_params["tokenizer"]
sample_seeds = preprocessing_params["sample_seeds"]
